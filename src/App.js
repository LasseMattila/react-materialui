...
/**
 * Main app file.
 * @param {string} word The word that is typed in to the dictionary.
 * @return {int} The App, main file of the program.
 */
function App() {
